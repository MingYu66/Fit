<template>
	...
	<view 
	v-else 
	class="gui-header-leader gui-flex gui-rows gui-nowrap gui-align-items-center gui-header-buttons-white gui-border-box" 
	:style="bgStyle">
		<view class="gui-header-leader-btns" 
		hover-class="gui-tap">
			<text 
			class="gui-header-leader-btns gui-block-text gui-icons gui-header-buttons-color-black" 
			@tap="gohome" 
		...
		class="gui-header-leader-btns" 
		hover-class="gui-tap">
			<text class="gui-header-leader-btns gui-block-text gui-icons gui-header-buttons-color-black" 
			@tap="goback" 
...
export default{
	...
	props : {
		homePage    : {type:String , default:"/pages/switchPages/index"},
