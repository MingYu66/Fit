...
public class SQLBatchInsertConverter {
    public static void main(String[] args) {
        String inputFile = "H:\\tr_trademark_owner.sql";
        String outputFile = "H:\\tr_trademark_owner_new2000.sql";
    ...
    private static void writeBatchInsert(PrintWriter writer, List<String> batchValues) {
        writer.println("INSERT INTO `tr_trademark_owner` VALUES ");
